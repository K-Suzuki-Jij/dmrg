...
void Model_1D_AKLM_TVF::Set_Onsite_Op() {
   ...
   Get_NC_On     (NC_On     , 1.0);
   Get_CEven_On  (CEven_On  , 1.0);
   Get_CEven_D_On(CEven_D_On, 1.0);
   Get_COdd_On   (COdd_On   , 1.0);
   Get_COdd_D_On (COdd_D_On , 1.0);
   Get_NCEven_On (NCEven_On , 1.0);
   Get_NCOdd_On  (NCOdd_On  , 1.0);
