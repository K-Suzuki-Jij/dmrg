...
void Model_1D_EKLM::Get_CUp_On(CRS &M, int target_ele_orbit, double coeef) {
   ...
   for (int row = 0; row < dim_onsite; row++) {
      ...
      for (int col = 0; col < dim_onsite; col++) {
         ...
         int c_ele_1 = (target_row_ele == 0 && target_col_ele == 1);
         int c_ele_2 = (target_row_ele == 2 && target_col_ele == 3);
         
         double val = coeef*sign;
