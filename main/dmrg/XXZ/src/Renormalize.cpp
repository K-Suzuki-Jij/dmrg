...
void Renormalize(Block_Operator &System, Block_Operator &Enviro, DMRG_Basis_Stored &Basis_System, DMRG_Basis_Stored &Basis_Enviro, DMRG_Block_Information &Block, DMRG_Basis &Basis, DMRG_Ground_State &GS, Model_1D_XXZ &Model, DMRG_Param &Dmrg_Param, Diag_Param &Diag_Param) {
   ...
   Basis.LLLRRRRL.qn1 = (double)Model.tot_sz*(Block.LL_site + Block.RR_site + 4)/Model.system_size;
   ...
   DMRG_Initial_Guess(GS, Basis.LLLRRRRL, Basis.LLLR, Basis_System, Basis_Enviro, Block, "Spin", Dmrg_Param.Initial_Guess ,Model.p_thread);
   ...
   DMRG_Print_Status("Spin", Model.BC, GS, Basis.LLLRRRRL, Basis_System, Basis_Enviro, Block, Dmrg_Param, Time);
