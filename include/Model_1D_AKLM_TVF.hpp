#ifndef Model_1D_AKLM_TVF_hpp
#define Model_1D_AKLM_TVF_hpp

#include <string>
#include "SML.hpp"

struct Model_1D_AKLM_TVF {
   ...
   int tot_parity;  //Total Sz in the Target Sector
   ...
   std::vector<int> Param_Tot_Ele, Param_Tot_Parity;
   
   std::vector<double> Param_t, Param_J_xy, Param_J_z, Param_I_xy, Param_I_z, Param_K_xy, Param_K_z;
   std::vector<double> Param_U, Param_V, Param_D_z, Param_hc_x, Param_hl_x, Param_mu;
   double t, J_xy, J_z, K_xy, K_z, I_xy, I_z, U, V, D_z, hc_x, hl_x, mu;
   ...
   CRS CEven_On, CEven_D_On, COdd_On, COdd_D_On, NCEven_On, NCOdd_On;
   ...
   int Find_Site_Parity(int basis);
   ...
   void Get_CEven_On  (CRS &M, double coeef);
   void Get_CEven_D_On(CRS &M, double coeef);
   void Get_COdd_On   (CRS &M, double coeef);
   void Get_COdd_D_On (CRS &M, double coeef);
   ...
   void Get_NCEven_On (CRS &M, double coeef);
   void Get_NCOdd_On  (CRS &M, double coeef);
